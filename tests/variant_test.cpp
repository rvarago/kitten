    ...
    SCENARIO("variant admits a multifunctor instance", "[variant]") {
        ...
        GIVEN("A variant") {
            ...
            AND_GIVEN("a function that maps all the choices") {
                ...
                auto choices_mapper = syntax::overloaded {
                ...
                WHEN("in an error choice") {
                    ...
                    THEN("return a mapped variant also in an error choice") {
                        ...
                        static_assert(
                                is_same_after_decaying<decltype(mapped_error), std::variant<std::optional<int>, std::string, error_t>>);
                ...
                WHEN("in an integer choice") {
                    ...
                    THEN("return a mapped variant also in an integer choice") {
                        ...
                        static_assert(
                                is_same_after_decaying<decltype(mapped_optional_of_integer), std::variant<std::optional<int>, std::string, error_t>>);
